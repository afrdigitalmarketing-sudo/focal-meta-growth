...
import trueGloryHairLogo from "@/assets/brands/true-glory-hair.png";
import busyBabyLogo from "@/assets/brands/busy-baby.png";
...
const row3: Brand[] = [
  { name: "True Glory Hair", logo: trueGloryHairLogo },
  { name: "Busy Baby", logo: busyBabyLogo },
